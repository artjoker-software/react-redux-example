...
module.exports = {
  ...
  module: {
    loaders: [
      { test: /\.jsx?$/, exclude: /node_modules/, loaders: ['babel?' + JSON.stringify(babelLoaderQuery)]}, // TODO: 'eslint-loader'
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      ...
      __DEVTOOLS__: false  // <-------- DISABLE redux-devtools here (btw, it causes initial double render!)
    }),
    new webpack.DefinePlugin({
      process: {
        env: {
          NODE_ENV: JSON.stringify(process.env.NODE_ENV || 'local'),
          GOOGLE_TRACKING_ID: JSON.stringify(process.env.GOOGLE_TRACKING_ID || 'UA-NNNNNN-N'),
